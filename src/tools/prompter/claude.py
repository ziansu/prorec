...
class AnthropicMetaPrompter(object):
...
class AnthropicSourceSummarizer(AnthropicMetaPrompter):
...
class AnthropicDecompSummarizer(AnthropicMetaPrompter):
...
class AnthropicDecompFuncNamer(AnthropicMetaPrompter):
